...
import { Menu, X, Home, Users, LogOut, BriefcaseMedicalIcon, HospitalIcon } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-gray-100 font-poppins">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-white ">Admin</h1>
          ...
          <Link to='/admin' className="flex items-center p-3 text-white hover:bg-blue-800">
            <Home className="w-5 h-5 mr-3" /> Dashboard
          </Link>
          <Link to='/admin/manage-users' className="flex items-center p-3 text-white hover:bg-blue-800">
            <Users className="w-5 h-5 mr-3" />Manage Users
          </Link>
          <button onClick={logout} className="flex items-center w-full p-3 text-white hover:bg-blue-800">
